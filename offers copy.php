...
<style>
  ...
  border-bottom: 4px solid #3a4a56;
  padding-bottom: 8px;
  margin-bottom: 20px;
}
...
.page-nav a.active-link::after {
  background-color: #82cfff; /* světle modré podtržení pro aktivní stránku */
}
        ...
        <div id="editOfferModal" class="modal-overlay">
            <div class="modal-content">
                ...
                <form method="POST">
                  ...
                  <button type="submit" name="edit_offer">Uložit</button>
                  <button type="button" onclick="closeEditModal()">Zrušit</button>
                </form>
            </div>
        </div>
</div>
